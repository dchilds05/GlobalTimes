            ...
            <div>
                {countryArr && countryArr.map( article => {
                    ...
                    <div>
                        ...
                        <button className = "blackButton" onClick={() => saveArticle(article)}>Save to favorites!</button>
                        <button className = "blueButton" onClick={() => deleteArticle(article)}>Saved!</button>
                    </div>
                    )
                })}
            </div>
